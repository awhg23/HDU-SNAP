...
RECENT_PATH = Path("debug_recent_10000.json")
ERROR_PATH = Path("debug_error_1000.json")
...
def generate_report(settings: Settings) -> None:
    global RECENT_PATH, ERROR_PATH, HTML_PATH, SUMMARY_PATH
    RECENT_PATH = settings.debug_recent_path
    ERROR_PATH = settings.debug_error_path
    HTML_PATH = settings.report_html_path
    SUMMARY_PATH = settings.report_summary_path
